export function Footer() {
  return (
    <footer className="relative bg-gradient-to-b from-white via-slate-50 to-slate-100 py-16 border-t border-slate-200/60">
      {/* Subtle gradient orb */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -bottom-48 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-gradient-to-t from-blue-500/10 via-violet-500/5 to-transparent rounded-full blur-3xl" />
      </div>
